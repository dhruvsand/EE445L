...
//extern uint32_t volatile TxPutI;// put next
//extern uint32_t volatile TxGetI;// get next
//uint32_t TxHistogram[TXFIFOSIZE];
//#define TxProfile() TxHistogram[(uint32_t)(TxPutI-TxGetI)]++;
